 ...
 (program
   ...
   (bb
    ...
    (stack-expand
     ...
     (bb
      ...
      (tail-call (local "gensym56") (env "gensym111")))
     (bb
      ((assign
        "gensym55"
   ...
   (bb
    ...
    (stack-expand
     ...
     (bb
      ...
      (tail-call (local "gensym94") (env "gensym111")))
     (bb
      ((assign "gensym91" (base "freadln"))
       (assign "gensym93" (base "stdin")))
      (stack-expand
       "gensym92"
       (bb () (tail-call (local "gensym93") (env "gensym111")))
  ...
  (fun
   ...
   (consts
    ...
    ("gensym108" (int 2)))
   (bb
    ((assign "gensym111" (base "$$authorityarg"))
     (mkclos
      (("gensym111" (local "gensym111")))
      (("fwriteln2" "fwriteln2")
