...
stack2JSWithMappings :: CompileMode -> Bool -> Bool -> DatatypeRecords -> Maybe String -> StackUnit -> (String, [Mapping])
stack2JSWithMappings compileMode debugMode sourceMapEnabled records moduleRoot su =
