   ...
   (bb
    ...
    (stack-expand
     ...
     (bb
      ...
      (tail-call (local "gensym56") (env "gensym108")))
     (bb
      ((assign
        "gensym55"
   ...
   (bb
    ...
    (stack-expand
     ...
     (bb
      ...
      (tail-call (local "gensym94") (env "gensym108")))
     (bb
      ((assign "gensym91" (base "freadln"))
       (assign "gensym93" (base "stdin")))
      (stack-expand
       "gensym92"
       (bb () (tail-call (local "gensym93") (env "gensym108")))
       (bb () (tail-call (local "gensym91") (local "gensym92"))))))))
  (fun
   "main"
   (arg "$$authorityarg")
   (consts
    ("gensym107" (float 1.5e10))
    ("gensym106" (float 3.14e-2))
    ("gensym105" (float 1000.5))
    ("gensym104" (float 3.141592)))
   (bb
    ((assign "gensym108" (base "$$authorityarg"))
     (mkclos
      (("gensym108" (local "gensym108")))
      (("fwriteln2" "fwriteln2")
              ...
              (stack-expand
               ...
               (bb
                ...
                (@
                 (rt "CaseElimination")
                 (ret
                  (@ (rt "CaseElimination") (local "gensym103"))))))))))))))))))))
