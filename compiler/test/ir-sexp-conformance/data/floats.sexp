   ...
   (bb
    ...
    (stack-expand
     ...
     (bb
      ...
      (tail-call (local "gensym56") (env "gensym107")))
     (bb
      ((assign
        "gensym55"
   ...
   (bb
    ...
    (stack-expand
     ...
     (bb
      ...
      (tail-call (local "gensym94") (env "gensym107")))
     (bb
      ((assign "gensym91" (base "freadln"))
       (assign "gensym93" (base "stdin")))
      (stack-expand
       "gensym92"
       (bb () (tail-call (local "gensym93") (env "gensym107")))
       (bb () (tail-call (local "gensym91") (local "gensym92"))))))))
  (fun
   "main"
   (arg "$$authorityarg")
   (consts ("gensym106" (float 3.14)) ("gensym105" (float 2.5)))
   (bb
    ((assign "gensym107" (base "$$authorityarg"))
     (mkclos
      (("gensym107" (local "gensym107")))
      (("fwriteln2" "fwriteln2")
