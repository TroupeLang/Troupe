(troupe-ir-sexp
 ...
 (program
  (fun
   ...
   (arg "$$authorityarg")
   (consts
    ("gensym9" (float 1.5e10))
    ("gensym8" (float 3.14e-2))
    ("gensym7" (float 1000.5))
    ("gensym6" (float 3.141592)))
   (bb
    ((assign "gensym10" (base "$$authorityarg")))
    (@
